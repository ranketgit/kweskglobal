...
Vérin qui s'affaisse, roulettes cassées, accoudoir desserré : ces défauts se réparent souvent en moins de 30 minutes. Avant de vous séparer du siège, consultez nos guides pour [changer le vérin à gaz](https://kwesk.com/fr/blog/entretien-et-reparation/changer-le-verin-a-gaz) ou [remplacer les roulettes du fauteuil](https://kwesk.com/fr/blog/entretien-et-reparation/remplacer-roulettes-fauteuil-bureau). Une réparation à 20 € peut prolonger la durée de vie de 3 à 5 ans.

### État 3 : Fauteuil endommagé ou obsolète

Mousse écrasée, structure fissurée, mécanisme HS : c'est ici que le recyclage prend tout son sens. Le siège entre dans une **filière de démantèlement** où chaque matériau est trié et valorisé séparément. Pour identifier ce stade, consultez les [signes qu'un fauteuil doit être remplacé](https://kwesk.com/fr/blog/entretien-et-reparation/duree-de-vie-fauteuil-de-bureau-signes-remplacement).
...
1. **Inscription en ligne** sur le portail Valdelia avec inventaire du mobilier
2. **Diagnostic** : Valdelia oriente vers réemploi ou recyclage selon l'état
3. **Enlèvement gratuit** par un opérateur agréé
4. **Attestation de traitement** délivrée pour votre rapport RSE
...
1. **Les conditions de reprise** : volume minimum, état accepté, zone géographique
2. **La valorisation proposée** : remise, crédit, ou simple enlèvement
3. **La destination du mobilier repris** : réemploi, recyclage, traçabilité
4. **L'attestation environnementale** fournie en fin d'opération

Cette approche s'inscrit dans une logique d'**économie circulaire** que de plus en plus de donneurs d'ordres exigent dans leurs appels d'offres. Pour les projets de [remplacement de fauteuils de bureau](https://kwesk.com/fr/blog/mobilier-bureau/remplacement-de-fauteuils-de-bureau) à grande échelle, c'est souvent l'option la plus fluide opérationnellement.

### Le marché du mobilier d'occasion professionnel

Si vos fauteuils ont une valeur résiduelle, la revente sur le marché de l'occasion professionnelle peut générer un complément financier. Plusieurs acteurs rachètent des lots de mobilier de bureau en bon état. Pour comprendre ce marché et ses prix, consultez notre guide sur le [mobilier d'occasion bureau](https://kwesk.com/fr/blog/mobilier-bureau/mobilier-occasion-bureau).
...
1. **Quel est l'état réel du parc ?** Faites un inventaire honnête, photo à l'appui
2. **Quel est le calendrier ?** Une reprise fabricant nécessite une coordination en amont
3. **Quels sont les objectifs RSE ?** Le réemploi vaut mieux que le recyclage en termes d'impact carbone
...
**Astuce** : si certains fauteuils présentent des défauts mineurs réparables, un atelier rapide en interne peut transformer un déchet en don valorisable. Les techniques pour [réparer un fauteuil qui grince ou s'affaisse](https://kwesk.com/fr/blog/entretien-et-reparation/reparer-fauteuil-bureau-grince-affaisse) sont simples à appliquer.
...
Les gammes [Gamma](https://kwesk.com/fr/chairs/gamma) et [Exclusive](https://kwesk.com/fr/chairs/exclusive) sont par exemple pensées pour un usage intensif sur 8 à 10 ans, avec des composants standards facilement remplaçables — un vrai plus pour limiter la production de déchets sur le long terme.
...
Vous préparez un renouvellement de votre parc de sièges et souhaitez bénéficier d'une solution de reprise associée à l'achat de fauteuils durables ? [Contactez l'équipe KWESK](https://kwesk.com/fr/contact) pour étudier ensemble un projet sur mesure, du diagnostic initial à l'enlèvement de vos anciens fauteuils.
