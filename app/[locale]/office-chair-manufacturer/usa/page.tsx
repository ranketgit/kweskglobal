      ...
      <section className="relative h-[90vh] min-h-[600px] flex items-center overflow-hidden bg-[#1c1917]">
        ...
        <div className="relative z-10 max-w-[900px] mx-auto px-6 text-center">
          ...
          <p className="text-lg text-[#d6d3d1] leading-[1.7] mb-10 max-w-3xl mx-auto">
            KWESK is a trusted <span className="font-bold text-white">office chair manufacturer</span> delivering premium commercial seating solutions to importers, distributors, and large-scale project developers across the USA. Since 2008, we have designed and produced <span className="font-bold text-white">BIFMA-certified bulk office chairs</span> and <span className="font-bold text-white">wholesale desk chairs</span> engineered for intensive daily use in corporate offices, coworking spaces, and government facilities. Whether you need to <span className="font-bold text-white">buy office chairs in bulk</span> for a commercial fit-out or source <span className="font-bold text-white">wholesale office chairs</span> for retail distribution, we provide factory-direct pricing with nationwide delivery and installation across all 50 states.
          </p>
