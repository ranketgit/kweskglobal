        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              ...
              <span className="text-xs text-stone-400 uppercase tracking-wider">Made in France</span>
            </div>
            <div>
              <span className="block text-2xl lg:text-3xl font-bold text-[#8b8b4b] mb-2">5 ans</span>
              <span className="text-xs text-stone-400 uppercase tracking-wider">Garantie</span>
            </div>
            <div>
              <span className="block text-2xl lg:text-3xl font-bold text-[#8b8b4b] mb-2">{cityData.City}</span>
              <span className="text-xs text-stone-400 uppercase tracking-wider">Livraison & Installation</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="lg:sticky lg:top-32">
              <span className="inline-block text-xs uppercase tracking-[3px] text-[#8b8b4b] mb-4">
                KWESK À {cityData.City.toUpperCase()}
              </span>
