...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://kwesk.com/fr/fabricant-de-chaises-de-bureau-professionnel/belgique/luxembourg',
  },
}
      ...
      <section className="py-24 bg-white border-b border-stone-200">
        <div className="max-w-4xl mx-auto px-6 lg:px-16 text-center">
          <h2 className="text-3xl font-bold text-[#1c1917] mb-6">
            Chaises de Bureau en Province de Luxembourg ? Trouvez Votre Ville
          </h2>
          <p className="text-stone-600 text-lg mb-10">KWESK, fabricant de chaises de bureau, livre directement les professionnels de la Province de Luxembourg. Prix usine, certifications BIFMA &amp; EN 1335, devis sous 24h.</p>

          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/fr/fabricant-de-chaises-de-bureau-professionnel/belgique/arlon" className="px-5 py-3 bg-stone-50 border border-stone-200 text-[#1c1917] font-bold text-sm hover:border-[#8b8b4b] hover:text-[#8b8b4b] transition-colors rounded-sm">Arlon</Link>
          </div>
        </div>
      </section>
