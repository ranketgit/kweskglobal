...
export default function ContactForm() {
  ...
  const inputClasses = "w-full p-[18px] border border-stone-200 focus:border-[#8b8b4b] outline-none transition-colors text-stone-900 placeholder:text-stone-400"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex flex-col gap-2">
                ...
                <input type="text" name="prenom" id="prenom" required placeholder={t('placeholders.firstName')} className={inputClasses} />
              </div>
              <div className="flex flex-col gap-2">
                <label className="text-[13px] font-medium text-stone-900 uppercase tracking-wider" htmlFor="nom">{t('fields.lastName')}</label>
                <input type="text" name="nom" id="nom" required placeholder={t('placeholders.lastName')} className={inputClasses} />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea name="message" id="message" required rows={6} placeholder={t('placeholders.message')} className={`${inputClasses} resize-none`} />
            </div>
