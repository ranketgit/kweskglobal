...
export default async function LocaleLayout({
  ...
  // NOTE: You don't need to fetch translations for the schema here anymore 
  // because the schema is handled in the component.
  ...
  return (
    <html lang={locale}>
      <head>
        ...
        {/* THIS HANDLES THE LOGIC. IT WILL HIDE ITSELF ON BLOG PAGES */}
        <GlobalJsonLd />
      </head>
      <body>
