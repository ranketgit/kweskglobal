...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getAlternates(locale, '/winner-c'),
    openGraph: { title: t('meta.title'), description: t('meta.description'), url: `${baseUrl}/${locale}/winner-c`, images: [{ url: `${baseUrl}/winner-c/hero.png` }] },
  }
}
